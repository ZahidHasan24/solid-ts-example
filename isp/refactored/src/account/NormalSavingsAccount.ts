import InternationalAmountTransferable from "../interface/InternationalAmountTransferable";
import SavingsAccount from "../interface/SavingsAccount";
import BaseAccount from "./BaseAccount";

class NormalSavingsAccount
  extends BaseAccount
  implements SavingsAccount, InternationalAmountTransferable
{
